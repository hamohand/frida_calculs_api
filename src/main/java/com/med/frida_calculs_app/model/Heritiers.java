...
public class Heritiers {
    ...
    // Parents
    private Heritier pere = new Heritier(HeirType.FATHER, F0);
    private Heritier mere = new Heritier(HeirType.MOTHER, F0);
    // Enfants
    private Heritier fille = new Heritier(HeirType.DAUGHTER, F0);
    private Heritier garcon = new Heritier(HeirType.SON, F0);
    // Fratrie
    private Heritier frere = new Heritier(HeirType.BROTHER, F0);
    private Heritier soeur = new Heritier(HeirType.SISTER, F0);
    // fraction de l'héritage non encore distribué (=HERITAGE au départ)
    private Heritier partRestant = new Heritier(HeirType.REMAINDER, HERITAGE);

    /*
     * private Heritiers(Heritier conjoint, Heritier pere, Heritier mere, Heritier
     * fille, Heritier garcon, Heritier frere, Heritier soeur, Heritier partRestant)
     * {
    ...
    public static Heritier conjoint(String sexe_defunt, Integer nb_filles, Integer nb_garcons) {
        ...
        Fraction part;
        Heritier heritier = new Heritier(HeirType.SPOUSE);
        if (nb_enfants == 0) {
    ...
    public static Heritier pere(boolean conjoint_vivant, int nb_filles, int nb_garcons) {
        int nb_enfants = nb_filles + nb_garcons;
        Fraction part;
        Heritier heritier = new Heritier(HeirType.FATHER);
    ...
    public static Heritier mere(boolean conjoint_vivant, int nb_filles, int nb_garcons, int nb_soeurs, int nb_freres) {
        ...
        Fraction part;
        Heritier heritier = new Heritier(HeirType.MOTHER);
        if ((nb_enfants != 0) || (conjoint_vivant)) { // il y a des enfants ou conjoint vivant
            part = HERITAGE.multiplier(F16);
    ...
    public static Heritier fille(Fraction fractionRestant, Integer nb_filles, Integer nb_garcons) {
        ...
        Fraction part;
        Heritier heritier = new Heritier(HeirType.DAUGHTER);
    ...
    public static Heritier garcon(Fraction fractionRestant, Integer nb_filles, Integer nb_garcons) {
        Fraction part;
        Heritier heritier = new Heritier(HeirType.SON);
    ...
    public static Heritier soeur(Fraction fractionRestant, Integer nb_soeurs, Integer nb_freres) {
        ...
        Fraction part;
        Heritier heritier = new Heritier(HeirType.SISTER);
    ...
    public static Heritier frere(Fraction fractionRestant, Integer nb_freres) {
        Fraction part;
        Heritier heritier = new Heritier(HeirType.BROTHER);
